...
public interface UserMapping extends BaseMapping<User, UserVo>  {
     ...
     * @return
     */
    @Mapping(target = "gender", source = "sex", qualifiedByName = "convertToGender")
    ...
    @Named("convertToGender")
    default Gender convert2Gender(Integer code) {
        return Gender.of(code);
    }

    default int convertFomrGender(Gender gender) {
